...
$format = <<<EOT
<p>La période d'inscription %s du site de démonstration sera ouverte du %s au %s.</p>
<p>Durant cette période, vous pouvez créer votre propre compte en tant que parent et simuler 
une ou plusieurs inscriptions. Vous pourrez également jouer le rôle du gestionnaire du service
de transport ou de l'administrateur de l'application en ligne.</p>
<p>Actuellement, vous pouvez entrer, uniquement en consultation, avec les rôles suivants :</p><ul>
