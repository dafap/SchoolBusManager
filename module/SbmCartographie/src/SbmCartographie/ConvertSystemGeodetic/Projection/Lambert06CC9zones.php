...
class Lambert06CC9zones extends AbstractProjection implements ProjectionInterface
{
    ...
    /**
     * Reçoit un point en coordonnées géographiques (RGF93 ou WPS84) exprimées en degré et renvoie un point en coordonnées de la zone
     *
     * @param Point $p
    ...
    /**
     * Reçoit un point en coordonnées de la zone et renvoie un point en coordonnées géographiques (RGF93 ou WPS84) exprimées en degré
     *
     * @param Point $p            
