...
/**
 *
 * @see `Guide_d'implementation_formulaire_paiement30012015081841.pdf` (Guide
 *      d'implementation du formulaire de paiement Systempay 2.2 - Version du document
 *      3.0)
 */
return [
    '02' => 'vads_site_id',
    ...
    '13' => 'vads_order_id', // référence de la commande (avec les
                              // responsableId-eleve1Id-eleve2Id...)
