...
class CommuneController extends AbstractActionController
{
     ...
     * - id (chaine de la forme millesime|ligneId
     * - ligneId
     * - origine (url sur la bonne page de la liste des lignes)
     *
     * @return \Zend\Http\PhpEnvironment\Response|\Zend\Http\Response|\Zend\View\Model\ViewModel
     */
    ...
    public function serviceGroupAction()
    {
        ...
        $view = new ViewModel(
            [
                ...
                'page' => $this->params('page', 1),
                'commune' => $result['userFeatures']->listeDesNoms(),
        ...
        $view->setTemplate('sbm-portail/commune/eleves.phtml');
        return $view;
    }
    ...
    {
        $retour = $this->url()->fromRoute('sbmportail/commune');
