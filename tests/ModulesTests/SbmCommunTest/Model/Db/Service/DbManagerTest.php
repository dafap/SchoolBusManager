...
class DbManagerTest extends PHPUnit_Framework_TestCase
{
     ...
     * <li>une section <b>'db'</b> contenant le paramétrage de la connexion à la base de
     * données ;</li> <li>dans cette section, une clé <b>'prefix'</b> contenant une chaine
     * de caractères ou vide ;</li> <li>dans la section <i>service_manager</i> un factory
     * dont l'alias est <b>'Zend\Db\Adapter\Adapter'</b>.<br> En général, il est déclaré
     * dans la configuration de l'application <i>`config/autoload`</i> ;</li> <li>une
     * section<b>'db_manager'</b> structurée en tableau associatif avec les clés
     * <b>'invokables'</b>, <b>'factories'</b>, etc.</li></ul> Ensuite, il faut que :<ul>
     * <li>la clé <b>'Sbm\DbManager'</b> soit déclarée en section <b>'factories'</b> de
     * <b>'service_manager'</b>.</li> <li>cette clé soit associée à la classe
     * <b>DbManager</b>.</li></ul>
     */
