...
class Effectif extends AbstractQuery implements FactoryInterface
{
    ...
    public function createService(ServiceLocatorInterface $db_manager)
    {
        ...
        $this->tableName['responsables'] = $db_manager->getCanonicName('responsables', 
            'table');
        $this->tableName['scolarites'] = $db_manager->getCanonicName('scolarites', 
            'table');
     ...
     *         <code>['nom' => nnn, 'alias' => aaa, 'inscrits' => value, 'internet' => value, 'papier' => value, 'transportes' => value)</code>
     *         <br>où<ul>
     ...
     * @return array <br><code>['annee_courante' => [], 'annee_precedente' => [])</code><br>
     *         où chaque tableau est composé de lignes de la forme :<br>
     *         <code>['nom' => nnn, 'inscrits' => value, 'internet' => value, 'papier' => value)</code>
     *         <br>où<ul>
     ...
     * @return array <br><code>['annee_courante' => [], 'annee_precedente' => [])</code><br>
     *         où chaque tableau est composé de lignes de la forme :<br>
     *         <code>['commune' => nnn, 'circuit' => aaa, 'inscrits' => value, 'internet' => value, 'papier' => value, 'transportes' => value)</code>
     *         <br>où<ul>
     *         <li><b>commune</b> est le nom de la commune</li>
     *         <li><b>circuit</b> est le code du service</li>
     *         <li><b>inscrits</b> est le nombre d'inscrits</li>
     ...
     * @return array <br><code>['annee_courante' => [], 'annee_precedente' => [])</code><br>
     *         où chaque tableau est composé de lignes de la forme :<br>
     *         <code>['etablissementId' => id, 'etablissement' =>nnn, 'commune' => vvv, 'classe' => ccc, 'inscrits' => value, 'internet' => value, 'papier' => value, 'transportes' => value)</code>
     *         <br>où<ul>
