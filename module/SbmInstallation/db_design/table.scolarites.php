...
return array(
    ...
    'structure' => array(
        'fields' => array(
            ...
            'station1mId' => 'int(11) NOT NULL DEFAULT "0"',
            'station1sId' => 'int(11) NOT NULL DEFAULT "0"',
            'station2Id' => 'int(11) NOT NULL DEFAULT "0"',
            'station2mId' => 'int(11) NOT NULL DEFAULT "0"',
            'station2sId' => 'int(11) NOT NULL DEFAULT "0"',
            'service1Id' => 'varchar(11) NOT NULL DEFAULT "0"',
            'service1mId' => 'varchar(11) NOT NULL DEFAULT "0"',
            'service1sId' => 'varchar(11) NOT NULL DEFAULT "0"',
            'service2Id' => 'varchar(11) NOT NULL DEFAULT ""',
            'service2mId' => 'varchar(11) NOT NULL DEFAULT ""',
            'service2sId' => 'varchar(11) NOT NULL DEFAULT ""',
