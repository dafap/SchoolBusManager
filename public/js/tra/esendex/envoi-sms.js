/**
 * Scripts de la page de sbm-esendex/index/envoi-sms.phtml
 * 
 * Ce script est dérivé du projet SMS Counter 
 * (Danilo R. Gonçalves - licence ISC- https://github.com/danxexe/sms-counter)
 * 
 * @project sbm
...
(function() {
  ...
  if (typeof jQuery !== "undefined" && jQuery !== null) {
    $ = jQuery;
    $.fn.countSms = function(target, maxparts) {
      var count_sms, input;
      this.attr("maxlength");
      input = this;
      target = $(target);
      max_length = function(event) {
    	  var encoding, per_message, maxlength, text;
    	  text = input.val();
    	  encoding = SmsCounter.detectEncoding(text);
    	  per_message = SmsCounter.multiMessageLength[encoding];
    	  maxlength = per_message * maxparts - 1;
