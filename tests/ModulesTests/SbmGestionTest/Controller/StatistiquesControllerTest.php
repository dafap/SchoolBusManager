<?php
/**
 * Test de la classe SbmGestion\StatistiquesController
 * 
 * @project sbm
 * @package ModuleTests/SbmGestionTest/Controller
 * @filesource StatistiquesControllerTest.php
 * @encodage UTF-8
...
class StatistiquesControllerTest extends AbstractHttpControllerTestCase
{
    ...
    public function testStatistiquesControllerFactory()
    {
        $controller_manager = $this->serviceManager->get('ControllerManager');
        $controller = $controller_manager->get(StatistiquesController::class);
