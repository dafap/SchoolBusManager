...
class Criteres implements ArraySerializableInterface
{
    ...
    /**
     * Tableau contenant éventuellement les clés 'pageheader_title' et 'pageheader_string' et leurs
     * valeurs.
     *
     * @var array
     */
     ...
     *
     * Si on recherche dans une requête où le nom d'un champ se trouve dans plusieurs tables, il
     * faut
     * préfixer le nom du champ. On utilise alors le tableau alias de la façon suivante:
     * Exemple: 'nomSA' => 'res.nomSA'
     *
     * Si on recherche une expression, on on utilisera le tableau $alias en faisant précéder
     * l'expression par 'Expression:'
     * Exemple: 'nbEnfants' => 'Expression:count(ele.eleveId) = ?'
     *
     * @param array $strict
     *            Tableau simple des champs pour lesquels on recherche l'égalité (les autres sont
     *            des likes)
     * @param array $alias
     *            Tableau associatif des champs dont il faut changer le nom, la clé n'étant qu'un
     *            alias
     *            
