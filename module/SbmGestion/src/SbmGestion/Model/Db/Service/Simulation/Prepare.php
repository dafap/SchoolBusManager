...
use SbmCommun\Model\Db\Service\Table\Exception as DbException;
use SbmCommun\Model\Strategy\Niveau;
use SbmCommun\Model\Db\Service\Table\SbmCommun\Model\Db\Service\Table;
...
class Prepare implements FactoryInterface
{
     ...
     * de la commune de résidence. Dans ce cas une DbException est lancée et on retrouvera
     ...
     *        
     * @throws \SbmCommun\Model\Db\Service\Table\Exception (DbException)
     */
     ...
     *        
     * @throws \SbmGestion\Model\Db\Service\Simulation\Exception pour une mauvaise configuration du RPI
     * @throws \SbmCommun\Model\Db\Service\Table\Exception pour un établissement qui n'est pas en RPI
     */
    private function etablissementEnRpi($etablissementId, $classeId)
    {
        ...
        if ($result->count() == 1) {
            ...
            if ($this->strategyNiveau->extract($classe->niveau) >=
                ...
                throw new DbException('Non concerné');
            }
