<?php
/**
 * Injection des objets dans SimulationController
 *
 * Préparation pour compatibilité avec ZF3
 * 
 * @project sbm
 * @package SbmGestion/Controller/Service
 * @filesource SimulationControllerFactory.php
 * @encodage UTF-8
...
class SimulationControllerFactory implements FactoryInterface
{
    ...
    public function createService(ServiceLocatorInterface $serviceLocator)
    {
        ...
        return new SimulationController($config_controller);
    }
}