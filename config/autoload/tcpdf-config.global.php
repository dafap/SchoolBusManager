...
//
// Description : Default alternative configuration file for TCPDF.
...
// ============================================================+
if (! defined('TCPDF_CONSTANTES')) {
    define('TCPDF_CONSTANTES', true);
    
    /**
     * Default alternative configuration file for TCPDF.
     *
     * @author Nicola Asuni
     ...
     */
    define('PDF_HEADER_LOGO', 'sbm-logo.gif');
     ...
     * Document author.
     */
    define('PDF_AUTHOR', 'Dafap informatique');
