<?php
/**
 * Service fournissant une liste des stations ouvertes sous la forme d'un tableau
 *   'stationId' => 'commune - nom'
 *
 * @project sbm
 * @package SbmCommun/Model/Db/Service/Select
 * @filesource StationsOuvertes.php
 * @encodage UTF-8
...
class StationsOuvertes implements FactoryInterface
{
