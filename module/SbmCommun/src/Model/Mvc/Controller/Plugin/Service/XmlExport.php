<?php
/**
 * Export par fichier xml téléchargeable
 * (Service déclaré dans module.config.php)
 *
 * Usage simple dans un controller :
 *   return $this->xmlExport('foo.xml', $header, $records);
 *   - nom du fichier produit: foo.xml
 ...
 *
 * Classe inspirée du module publié sur https://github.com/radnan/rdn-csv
 *
 * @project sbm
 * @package SbmCommun\Model\Mvc\Controller\Plugin\Service
 * @filesource XmlExport.php
 * @encodage UTF-8
...
class XmlExport extends AbstractPlugin
{
