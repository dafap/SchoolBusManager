...
use Zend\Form\Form;
use DafapTcpdf\Model\TcpdfFonts;
use DafapTcpdf\Model\Tcpdf;
...
class DocumentPdf extends Form
{
    ...
    private function getArrayPageFormats()
    {
        return array(
            ...
            'Japanese (JIS P 0138-61) Standard B-Series' => array(
            ...
            'Old Imperial English (some are still used in USA)' => array(
