 ...
 *
 * @project sbm
 * @package config/themes/ccmgc/view/sbm-installation/index
...
echo $this->ligneMenuAction('fam-bullet-go',
    [
        'filename' => 'sbm-front/index/index-avant.inc.html'
    ],
    [
...
echo $this->ligneMenuAction('fam-bullet-go',
    [
        'filename' => 'sbm-front/index/index-pendant.inc.html'
    ],
    [
...
echo $this->ligneMenuAction('fam-bullet-go',
    [
        'filename' => 'sbm-front/index/index-apres.inc.html'
    ],
    [
...
echo $this->ligneMenuAction('fam-bullet-go',
    [
        'filename' => 'sbm-front/index/index-ferme.inc.html'
    ],
    [
...
echo $this->ligneMenuAction('fam-bullet-go',
    [
        'filename' => 'sbm-parent/index/index-avant.inc.html'
    ],
    [
...
echo $this->ligneMenuAction('fam-bullet-go',
    [
        'filename' => 'sbm-parent/index/index-pendant.inc.html'
    ],
    [
...
echo $this->ligneMenuAction('fam-bullet-go',
    [
        'filename' => 'sbm-parent/index/index-apres.inc.html'
    ],
    [
...
echo $this->ligneMenuAction('fam-bullet-go',
    [
        'filename' => 'sbm-parent/index/index-ferme.inc.html'
    ],
    [
