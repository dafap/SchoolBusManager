...
class ListeLigneActions extends AbstractHelper
{
     ...
     *            cas, l'ensemble de caractères utilisé correspond à celui du document contenant
     *            l'élément &lt;form&gt;.</li>
     ...
     *            <i>on</i>
     *            ou <i>off</i>. La valeur par défaut est <i>on</i>.<ul>
     ...
     *            chaque utilisation du formulaire, ou le formulaire utilise son propre système
     *            d'auto-complétion ; le navigateur ne doit pas remplir automatiquement les
     *            valeurs.</li></ul>
     ...
     *            formulaires
     *            d'un document, et ne doit pas être une chaîne de caractères vide.</li>
     ...
     *            <li><i>_self</i> : charge la réponse dans le même contexte de navigation.
     *            Valeur par défaut.</li>
     *            <li><i>_parent</i> : charge la réponse dans le contexte de navigation parent
     *            de l'actuel.</li>
